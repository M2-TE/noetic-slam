...
## Dependencies
# Core:
RUN apt-get install -y python3-catkin-tools ros-noetic-pcl-ros gdb pip
# Ouster:
...
# Voxblox:
RUN apt-get install -y python3-wstool ros-noetic-cmake-modules protobuf-compiler autoconf
